...
async function main(): Promise<void> {
  ...
  // Register the service worker generated by vite-plugin-pwa. On first install
  // (or after an update) show a brief status message so the user knows the app
  // is ready to work without a network connection.
  registerSW({
    onRegisteredSW(_swUrl, _reg) {
      // SW registered — nothing to surface to the user yet.
    },
    onOfflineReady() {
      layout.setStatus("Ready to work offline", "ok");
    },
  });
